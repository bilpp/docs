...
As you are going to be publishing this extension, you'll want to make sure that the information is up to date. Take a minute to revisit `composer.json` and make sure package name, description, and Bilpp extension information are all correct. It is recommended to have a `README.md` file in your repository to explain what the extension is, so create one if you haven't already.
...
You will most likely want to create a discussion on the Bilpp Community in the [Extensions tag](https://discuss.bilpp.com/t/extensions). Other people can install your extension using the following command:
