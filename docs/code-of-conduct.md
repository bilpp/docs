...
### _Welcome to the Bilpp Community!_

... And thanks for joining us! We're excited about Bilpp, and are always happy to meet people who feel the same way. We want *everyone* to get the most out of Bilpp and the Bilpp community, so we ask that you please read and follow these guidelines. These apply whether you're using our forum, Discord chat, communicating on GitHub, or any other form of communication without the Bilpp community.

### Above All, Be Cool!

We're all here to talk about Bilpp, and to work together toward making it an even better application. Criticizing ideas (by means of reasoned arguments, of course) is an important part of that. But let's not get carried away and devolve into personal attacks, because negativity only gets in the way. We ask that you avoid the following:
...
Please make the effort to help us keep things organized. Time spent tidying up is time that we can't spend getting to know you, discussing your issues, and talking about Bilpp. And that, after all, is what we're all here to do!
...
- If you just want to post a bit of nonsense as a test, please do it in the [Test Posting](https://discuss.bilpp.com/t/sandbox) tag instead.
