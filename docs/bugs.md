...
If you discover a security vulnerability within Bilpp, please send an email to [security@bilpp.com](mailto:security@bilpp.com) so we can address it promptly.
:::

Thank you for helping us test Bilpp. We're happy to have you on the team! We need people who can *troubleshoot issues patiently* and *communicate them clearly*. As you probably know, good bug reporting takes some time and effort. If you're fine with that, then let's get started!
...
- Search our [Support forum](https://discuss.bilpp.com/t/support) to see if it's already been reported.
- We could be working on a fix, so search our [issue tracker](https://github.com/bilpp/core/issues) too.
...
We track issues on GitHub. Make sure you open your issue in the [correct repository](https://github.com/bilpp), and fill out all of the information in the Bug Report template.

If you can, check if the issue is reproducible with the latest version of Bilpp. If you are using a pre-release or development version, please indicate the specific version you are using.
